        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="{{url('admin/subcategory/list')}}" class="nav-link @if(Request::segment(2)=='subcategory') active @endif ">
                  <i class="nav-icon fas fa-list-alt"></i>
                  <p>
                    Sub Category
                  </p>
          ...
          <li class="nav-item">
            @auth
                <form class="nav-item" action="{{route('admin.logout')}}" method="post">
                  @method('delete')
                  @csrf 
                  <button class="nav-link w-100"><i class="fas fa-sign-out-alt"></i> Logout</button>
                </form>
            @endauth
          </li>
        </ul>
