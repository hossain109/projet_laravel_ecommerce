                        ...
                        <div class="product-gallery product-gallery-vertical">
                            <div class="row">
                                ...
                                <div id="product-zoom-gallery" class="product-image-gallery">
                                    ...
                                    <a class="product-gallery-item {{$loop->first?'active':''}}"  href="#" data-image="{{'upload/images/'.$item->name}}" data-zoom-image="{{'upload/images/'.$item->name}}">
                                        <img src="{{url('upload/images/'.$item->name)}}" alt="product side">
                                    </a>
                                    @endforeach
                    ...
                    <div class="col-md-6">
                        <div class="product-details">
                            ...
                            <div class="details-filter-row details-row-size">
                                <label>Color:</label>
                                {{-- @dd($product->getColors[0]->color->name) --}}
                                @foreach ($product->getColors as $item)
                                    <div class="widget-body">
                                        <div class="filter-colors">
                                            <a href="{{url('')}}" class="" style="background: {{$item->color->code}};"><span class="sr-only">Color Name</span></a>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                            ...
                            <div class="product-details-footer">
                                <div class="product-cat">
                                    <span>Category:</span>
                                    <a href="{{url($product->category->slug)}}">{{$product->category->category}}</a>,
                                </div><!-- End .product-cat -->
